...
const CreateUser = () => {
   ...
   const UserForm = async (data, setFieldError) => {
      try {
         const res = await axios.post("http://localhost:8000/api/createuser", data);
         ...
         if (res.status === 200) {
            ...
            if (res.data.errors.email) {
               setFieldError("email", res.data.errors.email);
            } else {
               setFieldError("mobile", res.data.errors.mobile);
            }
         }
      } catch (error) {
                                 ...
                                 <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                       <div className="form-group row mb-3">
                                          ...
                                          <div className="offset-lg-4 col-lg-8">{errors.status && touched.status ? <p style={{color: "red"}}>{errors.status}</p> : null}</div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
